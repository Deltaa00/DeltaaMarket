...
<div class="content-pembelian">
    <div class="container">
        <div class="left-panel">
            ...
            <img src="foto/gensin.jpg" class="foto-game" alt="Gambar Pembayaran">
            <div class=" text-game">
        ...
        <div class="right-panel">
            ...
            <form action="https://wa.me/6287790835101" method="post" id="paymentForm">
                ...
                <input type="text" id="idgensin" name="idgensin" placeholder="Masukan ID" required>

                <label for="email">Server</label>
                <select id="serverSelect" name="Server" required>
                    <option value="Server" disabled selected>Pilih Server</option>
                ...
                <select id="barang" name="barang" required>
                    ...
                    <option value="barang1">60 Genesis Crystal - Rp 15000</option>
                    <option value="barang1">330 Genesis Crystal - Rp 74000</option>
                    <option value="barang1">1910 Genesis Crystal - Rp 235000</option>
                    <option value="barang1">2345 Genesis Crystal - Rp 443000</option>
                    <option value="barang1">3880 Genesis Crystal - Rp 734000</option>
                    <option value="barang1">8880 Genesis Crystal - Rp 1734000</option>
                </select>
...
<script>
    function kirimPesanWhatsApp() {
        var idInput = document.getElementById('idgensin');
        var serverSelect = document.getElementById('serverSelect');
        var server = serverSelect.options[serverSelect.selectedIndex].text;
