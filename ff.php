...
<div class="content-pembelian">
    <div class="container">
        <div class="left-panel">
            <h1>Free Fire</h1>
            <img src="foto/ff.jpg" class="foto-game" alt="Gambar Pembayaran">
            <div class=" text-game">
        ...
        <div class="right-panel">
            ...
            <form action="https://wa.me/6287790835101" method="post" id="paymentForm">
                ...
                <input type="text" id="idff" name="idff" placeholder="Masukan ID" required>

                <label for="barang">List Top Up</label>
                <select id="barang" name="barang" required>
                    <option value="" disabled selected>Pilih Barang</option>
                    <option value="barang1">5 Diamonds - Rp 1000</option>
                    <option value="barang1">12 Diamonds - Rp 2000</option>
                    <option value="barang1">50 Diamonds - Rp 8000</option>
                    <option value="barang1">70 Diamonds - Rp 10000</option>
                    <option value="barang1">140 Diamonds - Rp 20000</option>
                    <option value="barang1">355 Diamonds - Rp 46000</option>
                    <option value="barang1">720 Diamonds - Rp 91000</option>
                    <option value="barang1">1450 Diamonds - Rp 180000</option>
                    <option value="barang1">2180 Diamonds - Rp 270000</option>
                    <option value="barang1">3640 Diamonds - Rp 450000</option>
                    <option value="barang1">7290 Diamonds - Rp 900000</option>
                </select>
...
<script>
    function kirimPesanWhatsApp() {
        var idInput = document.getElementById('idff') || document.getElementById('id8bp');
        ...
        var gameTitle = "Free Fire"; // Assuming you want this title for the first script
