...
<div class="content-pembelian">
    <div class="container">
        <div class="left-panel">
            ...
            <img src="foto/pubg.jpg" class="foto-game" alt="Gambar Pembayaran">
            <div class=" text-game">
        ...
        <div class="right-panel">
            ...
            <form action="https://wa.me/6287790835101" method="post" id="paymentForm">
                ...
                <input type="text" id="idpubg" name="idpubg" placeholder="Masukan ID" required>

                <label for="barang">List Top Up</label>
                <select id="barang" name="barang" required>
                    <option value="" disabled selected>Pilih Barang</option>
                    <option value="barang1">35 UC - Rp 7000</option>
                    <option value="barang1">73 UC - Rp 14000</option>
                    <option value="barang1">355 UC - Rp 70000</option>
                    <option value="barang1">720 UC - Rp 140000</option>
                    <option value="barang1">1925 UC - Rp 350000</option>
                    <option value="barang1">4000 UC - Rp 700000</option>
                    <option value="barang1">8400 UC - Rp 1400000</option>
                </select>
...
<script>
    function kirimPesanWhatsApp() {
        var idInput = document.getElementById('idpubg');
        ...
        var gameTitle = "PUBG Battlegrounds"; 
