...
<div class="content-pembelian">
    <div class="container">
        <div class="left-panel">
            <h1>Valorant</h1>
            <img src="foto/valo.jpg" class="foto-game" alt="Gambar Pembayaran">
            <div class=" text-game">
        ...
        <div class="right-panel">
            ...
            <form action="https://wa.me/6287790835101" method="post" id="paymentForm">
                ...
                <input type="text" id="idvalo" name="idvalo" placeholder="Masukan ID" required>

                <label for="barang">List Top Up</label>
                <select id="barang" name="barang" required>
                    <option value="" disabled selected>Pilih Barang</option>
                    <option value="barang1">125 Points - Rp 14000</option>
                    <option value="barang1">420 Points - Rp 46000</option>
                    <option value="barang1">700 Points - Rp 73000</option>
                    <option value="barang1">1375 Points - Rp 135000</option>
                    <option value="barang1">2400 Points - Rp 226000</option>
                    <option value="barang1">4000 Points - Rp 361000</option>
                    <option value="barang1">8150 Points - Rp 730000</option>
                </select>
...
<script>
    function kirimPesanWhatsApp() {
        var idInput = document.getElementById('idvalo');
